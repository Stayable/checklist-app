...
- **560/560 tests** (51 new), clean typecheck + lint, prod build OK, `/api/cron/network-digest` registered. **Not one of the 9 URLs has actually been posted to** — "configured" currently means resolves-from-env, not delivering.
