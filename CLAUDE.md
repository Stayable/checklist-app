...
- 🧑 **Left for Monday (Kyle's call):** the real Teams `@`-mention for Gerardo. **The email path is live and working now** — only the tag is missing, and it needs the Power Automate flow to construct a mention entity.
