...
**⏭ PLANS 4–7 (next):** 4 = completed view + home revamp + mark-opened/resume + photo timestamp/geo; 5 = manager dashboard + reports + PDF; 6 = recurrence polish (after Kate reviews `/rules`); 7 = template hard-delete (LAST, row-count-confirmed).
