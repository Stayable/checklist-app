...
**As of:** June 5, 2026
**Phase:** Weeks 1–3 done → **Phase 4 shipped + R2/photo pipeline live (ADR-015)**. Remaining in Phase 4: alpha demo for Rob; Resend email rows; issue resolution-photo (needs schema linkage, no longer R2-blocked).
