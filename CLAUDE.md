...
- **⚠ NOT VERIFIED:** neither `/legal/opt-in` nor `/legal/messaging` has been opened in a browser. Build + tests only. 🧑 **NEXT:** apply consent migration to prod → deploy → eyeball → screenshot → *then* publish the amendment (it cites two `ops.` URLs).
