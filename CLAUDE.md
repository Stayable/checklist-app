...
**🟢 SESSION 2026-08-01 (later) — TEAMS NOTIFICATION MODEL REBUILT + "All" TICKET TAB. Committed to `main` (`7487542` → `94020d1`), NOT pushed, migration NOT on prod, nothing deployed. ADR-027 recorded.**
