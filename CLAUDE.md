...
- **State:** on `main` at `610119b`, level with `origin/main`, clean tree. **No code, no schema change, no migration written yet.** Branch `feat/contractor-schedule` was created and deleted unused.
