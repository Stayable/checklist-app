...
async function main() {
  ...
  // Contractor directory seed (Component II — Contractor Dispatch MVP, ADR-025).
  // Roster confirmed by Kyle 2026-07-08. Contact numbers are PLACEHOLDERS —
  // real numbers (PII) are held until the prod/dev DB split; enter them via the
  // /contractors admin UI on the split prod DB. Idempotent: keyed by name.
