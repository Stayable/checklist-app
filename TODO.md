...
| 11 | 🧑 **Post a live probe to the 9 channels** | Routing is verified in code; **not one of the nine URLs has actually been posted to.** Until one is, "configured" means resolved-from-env, not delivering. Ask me and I'll send one |
