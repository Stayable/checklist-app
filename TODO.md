...
| 1 — merge gate | [x] | **CLEARED 2026-06-23** — Kate skipped Preview, chose merge-to-prod. FF merge `b55e073..9cf069d`, deploy `dpl_HKymj4…` READY, `ops.rentstayable.com` serving the desktop shell. (This merge also brought Phase 5 recurrence engine/cron/`/rules` to prod.) |
